...
export default function Home() {
	...
	return (
		<div className="flex flex-col items-center self-center mx-auto mt-6 text-2xl">
			<div className="font-serif text-3xl font-thin text-red-900">Dhammapada Reader</div>
			<img src={buddha} className="w-24 h-24 mt-10 mb-4 " alt="Lotus flower" />
			<div className="w-2/3 mb-8 font-serif text-base text-center">
				<p className="mb-2">
					The Dhammapada is a collection of sayings of the Buddha and one of the most widely read Buddhist
					scriptures.
				</p>
				...
				{hasTouchScreen ? (
					<p className="text-gray-800">Swipe sideways or use the side markers to go to next verse.</p>
				) : (
					<p className="text-gray-800">
						Navigate using your left/right arrow keys, scroll or by clicking the markers on the side of the
						text.
					</p>
				)}
			</div>
			<Link
				to="/dhammapada/1"
				className="font-serif text-sm text-red-900 lowercase border-b border-red-900 border-dashed"
			>
				start chapter one
			</Link>
